		...
		>
			...
			{:else}
				<svg class="h-5 w-5" viewBox="0 0 23 23" fill="currentColor">
					<path
						d="M11.5 0C5.15 0 0 5.15 0 11.5S5.15 23 11.5 23 23 17.85 23 11.5 17.85 0 11.5 0zm5.52 17.32c-.38.38-.88.6-1.42.6H7.4c-.54 0-1.04-.22-1.42-.6-.38-.38-.6-.88-.6-1.42V7.1c0-.54.22-1.04.6-1.42.38-.38.88-.6 1.42-.6h8.2c.54 0 1.04.22 1.42.6.38.38.6.88.6 1.42v8.8c0 .54-.22 1.04-.6 1.42zM9.5 8.5v6l5.5-3-5.5-3z"
					/>
				</svg>
			{/if}
			Sign in with {label}
